...
class quick_start(object):
    ...
    def bios_policies(self, **kwargs):
        ...
        print(f'  - {os.path.join(baseRepo, org, self.type, "compute.yaml")}')
        print(f'\n-------------------------------------------------------------------------------------------\n')
        #==============================================
    ...
    def boot_and_storage(self, **kwargs):
        ...
        print(f'  - {os.path.join(baseRepo, org, self.type, "compute.yaml")}')
        print(f'  - {os.path.join(baseRepo, org, self.type, "storage_policies.yaml")}')
        print(f'\n-------------------------------------------------------------------------------------------\n')
        #==============================================
    ...
    def domain_policies(self, **kwargs):
        ...
        while configure_loop == False:
            ...
            print(f'  Profile.\n')
            print(f'  This wizard will save the output for these pools in the following files:\n')
            print(f'  - {os.path.join(baseRepo, org, self.type, "domain.yaml")}')
            print(f'  - {os.path.join(baseRepo, org, self.type, "management.yaml")}')
            print(f'  - {os.path.join(baseRepo, org, self.type, "port.yaml")}')
            print(f'  - {os.path.join(baseRepo, org, self.type, "switch.yaml")}')
            print(f'  - {os.path.join(baseRepo, org, self.type, "vlan.yaml")}')
            print(f'  - {os.path.join(baseRepo, org, self.type, "vsan.yaml")}')
            print(f'  - {os.path.join(baseRepo, org, "profiles", "chassis.yaml")}')
            print(f'  - {os.path.join(baseRepo, org, "profiles", "domain.yaml")}')
            print(f'\n-------------------------------------------------------------------------------------------\n')
    ...
    def lan_san_policies(self, **kwargs):
        ...
        while configure_loop == False:
            ...
            print(f'  This wizard will save the output for these pools in the following files:\n')
            print(f'  - {os.path.join(baseRepo, org, self.type, "ethernet.yaml")}')
            print(f'  - {os.path.join(baseRepo, org, self.type, "fibre_channel.yaml")}')
            print(f'  - {os.path.join(baseRepo, org, self.type, "lan_connectivity.yaml")}')
            print(f'  - {os.path.join(baseRepo, org, self.type, "san_connectivity.yaml")}')
            print(f'\n-------------------------------------------------------------------------------------------\n')
    ...
    def pools(self, **kwargs):
        ...
        while configure_loop == False:
            ...
            print(f'  This wizard will save the output for these pools in the following files:\n')
            print(f'  - {os.path.join(baseRepo, org, self.type, "pools.yaml")}')
            print(f'\n-------------------------------------------------------------------------------------------\n')
    ...
    def server_policies(self, **kwargs):
        ...
        while configure_loop == False:
            ...
            print(f'  - {os.path.join(baseRepo, org, self.type, "environment.yaml")}')
            print(f'  - {os.path.join(baseRepo, org, self.type, "management.yaml")}')
            print(f'\n-------------------------------------------------------------------------------------------\n')
    ...
    def server_profiles(self, **kwargs):
        ...
        while configure_loop == False:
            ...
            print(f'  Profile.\n')
            print(f'  This wizard will save the output for these pools in the following files:\n')
            print(f'  - {os.path.join(baseRepo, org, self.type, "ucs_server_profile_templates.yaml")}')
            print(f'  - {os.path.join(baseRepo, org, self.type, "ucs_server_profiles.yaml")}')
            print(f'\n-------------------------------------------------------------------------------------------\n')
